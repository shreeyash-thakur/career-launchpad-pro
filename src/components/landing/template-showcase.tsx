...
const CATEGORY_MAP: Record<string, string[]> = {
  ...
  Corporate:     ["executive", "modern"],
  Creative:      ["creative", "bold-header", "startup"],
  Minimal:       ["minimal"],
  Developer:     ["developer", "tech-grid", "compact-ats"],
  Student:       ["minimal", "modern", "startup"],
  Executive:     ["executive", "elegant", "academic"],
  Elegant:       ["elegant"],
  Engineering:   ["developer", "tech-grid", "compact-ats"],
  Marketing:     ["creative", "bold-header"],
  Finance:       ["executive", "minimal", "elegant"],
  Medical:       ["academic", "minimal"],
  "ATS Friendly": ["compact-ats", "developer", "minimal", "modern"],
  Timeline:      ["timeline"],
  "One Page":    ["minimal", "compact-ats", "modern"],
};
