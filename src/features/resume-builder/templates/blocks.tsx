...
function Heading({ children, look }: { children: ReactNode; look: Look }) {
  return (
    <h3 className={look.headingClass}>
      {children}
      {look.rule ? <span className="mt-1 block h-px w-full bg-current/15" /> : null}
    </h3>
  );
}
...
export function SectionBody({
  ...
  if (kind === "summary") {
    ...
    return (
      <section className={look.sectionClass}>
        <Heading look={look}>Summary</Heading>
  ...
  if (kind === "experience") {
    ...
    return (
      <section className={look.sectionClass}>
        <Heading look={look}>Experience</Heading>
        <div className={entryGap}>
          {data.experience.map((exp) => (
            <div key={exp.id}>
              ...
              <Bullets items={exp.bullets.filter(Boolean)} bullet={look.bullet} />
            </div>
          ))}
        </div>
      </section>
  ...
  if (kind === "education") {
    ...
    return (
      <section className={look.sectionClass}>
        <Heading look={look}>Education</Heading>
        <div className={entryGap}>
  ...
  if (kind === "skills") {
    ...
    return (
      <section className={look.sectionClass}>
        <Heading look={look}>Skills</Heading>
  ...
  if (kind === "projects") {
    ...
    return (
      <section className={look.sectionClass}>
        <Heading look={look}>Projects</Heading>
        <div className={entryGap}>
  ...
  if (kind === "certifications") {
    ...
    return (
      <section className={look.sectionClass}>
        <Heading look={look}>Certifications</Heading>
  ...
  if (kind === "languages") {
    ...
    return (
      <section className={look.sectionClass}>
        <Heading look={look}>Languages</Heading>
  ...
  if (kind.startsWith("custom:")) {
    ...
    return (
      <section className={look.sectionClass}>
        <Heading look={look}>{section.title || "Custom section"}</Heading>
        <div className={entryGap}>
